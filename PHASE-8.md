...
This phase caches the application shell only. Video files, FFmpeg core assets, and AI/Whisper model downloads are not silently cached because they can be large and device-dependent.
